...
function initCal(obj){
	...
	//var iconUrl    = obj.iconUrl == null ? "../images/common/calendar.png" : obj.iconUrl ;
...
function drawCalForm(id,tId,calType,min,max,todayYN,iconYN,imageUrl){ // tId = 입력창ID
	...
	// 상단 년,달 이동
	var html  = "<div class='calTitle'><table width='100%'><tr><td id='"+ id +"before' width='10%'  style='font-size: 10px'><img src='../images/cal_arrow_left.png'></td><td width='63%' align='center'>";
	...
	html += "</td><td id='"+ id +"next' width='10%' style='font-size: 10px'><img src='../images/cal_arrow_right.png'></td></tr></table></div>";
