...
<script>
	...
	function loadContentTypeStat() {
		var url = '/ccsearch/v1/group_by_count.do?index=ccontents_service&&key=meta_container.metadata.genre';
		console.log("URL :: ["+url+"]");
		$.ajax({
	        url: url,
	        type:'get',
	...
	function loadGenreStat() {
		var url = '/ccsearch/v1/group_by_count.do?index=ccontents_service&key=meta_container.content-type';
		console.log("URL :: ["+url+"]");
		$.ajax({
	        url: url,
	        type:'get',
...
<body>
	...
	<div id="menu_id" class="smenu_202"></div>
