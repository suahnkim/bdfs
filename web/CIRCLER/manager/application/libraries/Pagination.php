...
class Pagination{
    ...
    public static function makePage($base_url, $total_rows, $limit = 10, $num_links = 5, $query_string_segment = 'pageNum'){
        ...
        foreach ($pages as $key=>$page){
            switch($page['pos']){
                case "prev":
                    $html .= '<li class="arr" onclick="location.href=\''.$page['url'].'\'"><i class="fas fa-chevron-left"></i>';
                    break;
                case "next":
                    $html .= '<li class="arr" onclick="location.href=\''.$page['url'].'\'"><i class="fas fa-chevron-right"></i></li>';
                    break;
                case "num":
                    $html .= '<li onclick="location.href=\''.$page['url'].'\'"><a href="javascript:;">'.$page['num'].'</a></li>';
                    break;
                case "cur":
                    $html .= '<li class="on" onclick="location.href=\''.$page['url'].'\'"><a href="javascript:;">'.$page['num'].'</a></li>';
                    break;
                case "first":
                case "last":
                    break;
