...
<section class="body-sign">
	...
	<div class="login-bg">
		...
		<div class="login-pos">
			<a href="/" class=""><img src="<?php echo COM_ASSETS_PATH; ?>/img/icon/logo_new.png" height="64" alt="Mediablockchain" /></a>
		</div>		
				...
				<form class="jca-login-form">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" style="margin-top:5px;">
                            <a href="/main/programDownload" class="btn btn-primary" target="_blank" style="width:50%;">Program Download</a>
                        </div>
                    </div>
                    <span class="mt-3 mb-3 line-thru text-center text-uppercase" style="margin-top:0 !important;margin-bottom:0.5rem !important;padding:15px 0 15px 0;">
						<span>or</span>
						<p class="joinbtn">Don't have an account yet? <a href="/user/generate">Sign Up!</a></p>
					</span>
        ...
        if(master_eth_account == address){
           ...
           //console.log(auth_data);
            if(auth_data.resultCode == 0 && auth_data.result == 'succeed'){
                ...
                console.log(deamon_params);
                var daemon_data  = $.runsync( 'http://localhost:54777' , deamon_params , 'json' , true);
...
function deamonData(){
    ...
    var daemon_data  = $.runsync( 'http://localhost:54777' , deamon_params , 'json' , false);
    console.log(daemon_data);
    alert('aee');
}
deamonData();*/
