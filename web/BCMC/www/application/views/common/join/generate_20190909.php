...
/*
    ...
    $('.account_tab li').on('click' , function (event) {
        ...
        $(id).addClass('active');
        if($(this).index() == 1){
            $('#new_etherum_account input[name=ethereum_password]').attr({'required' : true , 'disabled' : false});
            $('#exists_etherum_account input[name=ethereum_password]').attr({'required' : false , 'disabled' : true});
        }else{
            $('#exists_etherum_account input[name=ethereum_password]').attr({'required' : true , 'disabled' : false});
            $('#new_etherum_account input[name=ethereum_password]').attr({'required' : false , 'disabled' : true});
        }
    });
