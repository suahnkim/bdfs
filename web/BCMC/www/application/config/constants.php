...
define('SITE_DESCRIPTION', '블럭체인을 활용한 대용량 미디어 유통 플랫폼 미디어블로체인 입니다.');
define('SITE_WRITER', 'www.mediablockchain.co.kr');
define('SITE_COPYRIGHT', '© 2019 peopleNstory.com Inc.');
define('SITE_REPLYTO', 'help@mediablockchain.co.kr');
...
define('FTP_IMAGE_PATH', 'images');

define('CONTENTS_IMAGE_URL', 'coimg.circler.co.kr');
define('PACKAGE_API_URL' , 'package_api_url');
define("MASTER_ETH_ACCOUNT_ID" , "master_eth_account_id")
?>
