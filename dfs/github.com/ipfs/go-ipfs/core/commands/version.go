...
var VersionCmd = &cmds.Command{
	...
	Run: func(req *cmds.Request, res cmds.ResponseEmitter, env cmds.Environment) error {
		return cmds.EmitOnce(res, &VersionOutput{
			...
			MBVersion: version.CurrentMBVersion,
	...
	Encoders: cmds.EncoderMap{
		cmds.Text: cmds.MakeTypedEncoder(func(req *cmds.Request, w io.Writer, version *VersionOutput) error {
			...
			if all {
				out := fmt.Sprintf("go-ipfs version: %s-%s\nMediaBlockchain version: %s\n"+
					"Repo version: %s\nSystem version: %s\nGolang version: %s\n",
					version.Version, version.Commit, version.MBVersion, version.Repo, version.System, version.Golang)
				fmt.Fprint(w, out)
				return nil
			}
			...
			fmt.Fprint(w, fmt.Sprintf("ipfs version %s%s\nMediaBlockchain version: %s\n", version.Version, commitTxt, version.MBVersion))
			return nil
		}),
	},
	Type: VersionOutput{},
